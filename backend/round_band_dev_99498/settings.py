"""
Django settings for round_band_dev_99498 project.
...
ROOT_URLCONF = 'round_band_dev_99498.urls'
...
WSGI_APPLICATION = 'round_band_dev_99498.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_band_dev_99498 API",
    "DESCRIPTION": "API documentation for round_band_dev_99498 App",
    "VERSION": "v1",
}
